...
class __USE_STATIC_ACCESS__Email
{
	...
	******************************************************************************************/
	...
	{	
		die(getErrorMessage('Error', 'undefinedFunction', "Email::$method()"));	
	}
	...
	******************************************************************************************/
	public function settings($settings = array())
	{
		...
		{
			Error::set(lang('Error', 'emailParameter', '1.(settings)'));	
			return $this;
		}
	...
	******************************************************************************************/
	public function smtpHost($host = '')
	{
		...
		{
			Error::set(lang('Error', 'scalarParameter', '1.(host)'));	
		}
	...
	******************************************************************************************/
	public function smtpUser($user = '')
	{
		...
		{
			Error::set(lang('Error', 'scalarParameter', '1.(user)'));	
		}
	...
	******************************************************************************************/
	public function smtpDsn($dsn = true)
	{
		...
		{
			Error::set(lang('Error', 'booleanParameter', '1.(dsn)'));	
		}
	...
	******************************************************************************************/
	public function smtpPassword($pass = '')
	{
		...
		{
			Error::set(lang('Error', 'scalarParameter', '1.(pass)'));	
		}
	...
	******************************************************************************************/
	public function smtpPort($port = 587)
	{
		...
		{
			Error::set(lang('Error', 'numericParameter', '1.(port)'));	
		}
	...
	******************************************************************************************/
	public function smtpTimeout($timeout = 10)
	{
		...
		{
			Error::set(lang('Error', 'numericParameter', '1.(timeout)'));	
		}
	...
	******************************************************************************************/
	public function smtpKeepAlive($keepAlive = true)
	{
		...
		{
			Error::set(lang('Error', 'booleanParameter', '1.(keepAlive)'));	
		}
	...
	******************************************************************************************/
	public function smtpEncode($encode = '')
	{
		...
		{
			Error::set(lang('Error', 'stringParameter', '1.(encode)'));	
		}
	...
	******************************************************************************************/
	public function to($to = '', $name = '')
	{
		...
		{
			Error::set(lang('Error', 'emailParameter', '1.(to)'));	
		}
	...
	******************************************************************************************/
	public function replyTo($replyTo, $name)
	{
		...
		{
			Error::set(lang('Error', 'emailParameter', '1.(replyTo)'));	
		}
	...
	******************************************************************************************/
	public function cc($cc, $name)
	{
		...
		{
			Error::set(lang('Error', 'emailParameter', '1.(cc)'));	
		}
	...
	******************************************************************************************/
	public function bcc($bcc = '', $name = '')
	{
		...
		{
			Error::set(lang('Error', 'emailParameter', '1.(bcc)'));	
		}
	...
	******************************************************************************************/
	public function from($from = '', $name = '', $returnPath = NULL)
	{
		if( ! isEmail($from) )
		{
			Error::set(lang('Error', 'emailParameter', '1.(from)'));
			return $this;	
		}
	...
	******************************************************************************************/
	public function subject($subject = '')
	{
		...
		{
			Error::set(lang('Error', 'stringParameter', '1.(subject)'));	
		}
	...
	******************************************************************************************/
	public function message($message = '')
	{
		...
		{
			Error::set(lang('Error', 'stringParameter', '1.(message)'));	
		}
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedBuildHeaders()
	{
		...
		$this->addHeader('Message-ID',   $this->protectedGetMessageId());
		$this->addHeader('Mime-Version', $this->mimeVersion);
		$this->addHeader('Date',         $this->protectedGetDate());
	}
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedGetDate()
	{
		$timezone = date('Z');
		$operator = ( $timezone[0] === '-' ) ? '-' : '+';
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedMimeMessage()
	{
	...
	*******************************************************************************************
	| Genel Kullanım: İçerik türü belirlenir.												  |
	
	  @param  void
	  @return string
	|          																				  |
	******************************************************************************************/
	protected function protectedContentType()
	{
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	public function protectedBoundary()
	{
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedWriteHeaders()
	{
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedGetMessageId()
	{
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedToArray($email = '')
	{
		if( ! is_array($email) )
		{
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedToString($email = '')
	{
		if( is_array($email) )
		{
			$string = '';
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedBuildContent()
	{	
		$this->protectedBuildHeaders();
		$this->protectedBoundary();
		$this->protectedWriteHeaders();
		...
		if( in_array($this->multiPart, $this->multiParts) && ! empty($this->attachments) ) 
		{
			...
			$body 	.= $this->protectedMimeMessage().$this->crlf;
	...
	******************************************************************************************/
	public function attachment($file = '', $disposition = '', $newName = NULL, $mime = 'application/octet-stream')
	{
		...
		if( $mime === '' )
		{
			...
			{
				return Error::set(lang('Email', 'attachmentMissing', $file));
			}
			
			if( ! $fp = @fopen($file, 'rb') )
			{
				return Error::set(lang('Email', 'attachmentUnreadable', $file));
			}
	...
	******************************************************************************************/
	public function send($subject = '', $message = '')
	{
		if( ! isset($this->headers['From']) )
		{
			...
			{
				return Error::set(lang('Email', 'noFrom'));
			}
		}
		...
		if( ! empty($this->to) ) 
		{
			$this->addHeader('To', $this->protectedToString($this->to));
		}
		
		if( ! empty($this->cc) )
		{
			$this->addHeader('Cc', $this->protectedToString($this->cc));
		}
		
		if( ! empty($this->bcc) )
		{
			$this->addHeader('Bcc', $this->protectedToString($this->bcc));
		}
		
		$this->protectedBuildContent();
		...
		if( empty($send) )
		{
			return Error::set(lang('Email', 'noSend'));
		}
		
		$this->protectedDefaultVariables();
	...
	*******************************************************************************************
	...
	|          																				  |
	******************************************************************************************/
	protected function protectedDefaultVariables()
	{
		$this->subject		= '';
		$this->message		= '';
		$this->header		= '';
