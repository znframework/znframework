<?php	
class __USE_STATIC_ACCESS__Functions
{
	/***********************************************************************************/
	/* FUNCTIONS LIBRARY				                   	                           */
	/***********************************************************************************/
	...
	/*
	/* Sınıf Adı: Functions
	/* Versiyon: 2.0 Ağustos Güncellemesi
	/* Tanımlanma: Karışık
	/* Dahil Edilme: Gerektirmez
	/* Erişim: Functions::, $this->Functions, zn::$use->Functions, uselib('Functions')
	...
	******************************************************************************************/
	...
	{	
		die(getErrorMessage('Error', 'undefinedFunction', "Functions::$method()"));	
	}
