...
class Route implements RouteInterface
{
    ...
    {
        $invalidRequest = $this->getConfig['requestMethods'];
    ...
    protected function _csrf()
    {
        if( ! empty($this->csrfs) )
        {
            ...
            {
                $redirect = $this->redirects[CURRENT_CFURI]['redirect'] ?? $this->getConfig['requestMethods']['page'];
        ...
        if( ! empty($this->restores) )
        {
            if( $restore = ($this->restores[CURRENT_CFURI]['restore'] ?? NULL) )
            {
                $routeURI = empty($restore['uri'])
                          ? $this->redirects[CURRENT_CFURI]['redirect'] ?? Config::get('Project', 'restoration')['routePage']
                          : $restore['uri'];
    ...
    //
    //--------------------------------------------------------------------------------------------------------
    protected function _redirect($direct = NULL)
    {
        $direct = $this->getConfig['requestMethods']['page'];
