...
use ZN\Services\Exception\SMTPEmptyHostNameException;
use ZN\Services\Exception\SMTPEmptyUserPasswordException;
use ZN\Services\Exception\SMTPFailedLoginException;
use ZN\Services\Exception\SMTPDataFailureException;
use ZN\Services\Exception\SMTPAuthException;
