...
$lang['Error']['boolParameter']			    = '`%` parameter should contain the bool data type!';
...
$lang['Error']['intParameter']		    	= '`%` parameter should contain the int data type!';
$lang['Error']['integerParameter']	    	= '`%` parameter should contain the integer data type!';
...
$lang['Error']['typeHint']                  = '& parameter should be %!';