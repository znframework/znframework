...
[
    ...
    'dirNotWrite'               => 'Error: `%` dir can not create! Please check the permits of dir creation!',
    ...
    'invalidDriverFunction'     => '`%` driver haven`t `#`() method!',
    ...
    'noError'                   => 'Error is not found.',
    'stringParameter'           => '`%` parameter should contain the string data type!',
    'booleanParameter'          => '`%` parameter should contain the boolean data type!',
    'boolParameter'             => '`%` parameter should contain the bool data type!',
    ...
    'arrayParameter'            => '`%` parameter should contain the array data type!',
    'objectParameter'           => '`%` parameter should contain the object data type!',
    'numericParameter'          => '`%` parameter should contain the numeric data type!',
    'intParameter'              => '`%` parameter should contain the int data type!',
    'integerParameter'          => '`%` parameter should contain the integer data type!',
    'valueParameter'            => '`%` parameter should contain the string, numeric or boolean data type!',
    'scalarParameter'           => '`%` parameter should contain the scalar data type!',
    ...
    'stringArrayParameter'      => '`%` parameter should contain the string or array data type!',
    'dirParameter'              => '`%` parameter should contain the dir data type!',
    'fileParameter'             => '`%` parameter should contain the file data type!',
    'fileDirParameter'          => '`%` parameter should contain the file or dir data type!',
