...
class InternalJSP extends \FactoryController
{
    ...
    [
        ...
        [
            ...
            'ajax'                  => 'JSP\Ajax::send',
            'ajaxurl'               => 'JSP\Ajax::url',
            'ajaxdata'              => 'JSP\Ajax::data',
            'ajaxdatatype'          => 'JSP\Ajax::datatype',
            'ajaxsuccess'           => 'JSP\Ajax::success',
            'ajaxerror'             => 'JSP\Ajax::error',
            'ajaxmethod'            => 'JSP\Ajax::method',
        ]
    ];
}
