...
[
    ...
    [
        ...
        //----------------------------------------------------------------------------------------------
        //
        // User kütüphanesi çoklu database kullanımından etkilenir. Bu kütüphanenin database ayarlarını
        // sabit hale getirmek database ayarını doğrudan dizi olarak belirterek kullanmanız
        // gerekmektedir.
        //
        //----------------------------------------------------------------------------------------------
        'staticConnection' => [],
